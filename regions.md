...
For example: for France, I copied the directory [individuals/france/regionsTopoNewName](individuals/france/regionsTopoNewName) to [maps/france](maps/france) and renamed it [regions](maps/france/regions).
